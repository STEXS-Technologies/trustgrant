...
| `DuplicateAudienceAuthority` | A duplicate audience authority entry is present. | The same `authority_id` appears more than once in a scope's audience entries. At most one entry per authority is allowed. |
